package com.example.win.onlinechat;
...
public class MainActivity extends AppCompatActivity {
    ...
    FirebaseDatabase database = FirebaseDatabase.getInstance(); //получає силку на бд.
    DatabaseReference myRef = database.getReference("messages");//получає доступ на блок де зберігаються дані
